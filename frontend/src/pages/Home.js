        ...
        <body>
            ...
            <div className="app-body-container">
                ...
                <div className="App-body">
                    ...
                    <h1 className="home-h1">RESUME</h1>
                    ...
                    <h3 className="home-h3">
                        ...
                        <br />
                        <br />
                        Learn more about how I've created this web-app using React.js and Spring-boot below.
                        <br></br>
                        <br></br>
                        <a className="resume-link" href="https://github.com/ucsb-cs156-w22/team04-w22-5pm-courses" target="_blank">Course-Search Web App: </a>
                        <br></br>
                        ...
                        <br></br>
                        <br></br>
                        <a className="resume-link" href="https://github.com/tiny-babies/YelpCamp" target="_blank">Yelp-Camp: </a>
                        <br></br>
                        ...
                        <br />
                        <br />
                        <a className="resume-link" href="https://github.com/tiny-babies/VaxMan" target="_blank">Vax-Man: </a>
                        <br></br>
                    ...
                    <div id="resume-transcript-wrapper">
                        ...
                        <a href="#" className="resume-btn">TRANSCRIPT</a>
                    </div>
                    ...
                    <div className="contact">
                        ...
                        <ul id="contact-list">
                            <li>
                                <a className="btn btn-lg btn-outline-info" href="https://www.linkedin.com/in/njohnsonucsb" target="_blank">
                            ...
                            <li>
                                <a href="https://github.com/tiny-babies" target="_blank" className="btn btn-lg btn-outline-info">
